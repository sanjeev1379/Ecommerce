...
if(isset($_POST['register_connect'])){
  ...
  if(!empty($first_name)&&!empty($email)&&!empty($birthday)&&!empty($address)&&!empty($password)&&!empty($password_again)){
  if($password_hash!=$password_again_hash){
    echo "<script>alert('Password do not match!')</script>";
    echo  "<script>window.open('register.php','_self')</script>";
  }else{
    $query=mysql_query("INSERT INTO account (first_name,last_name,mobile_no,email,profile_image,select_sex,birthday,address,password,password_again) VALUES ('$first_name','$last_name','$mobile_no','$email','$profile_image','$select_sex','$birthday','$address','$password_hash','$password_again_hash')");
    if($query_run=mysql_query($query)){
    }else{
      echo "<script>alert('You are Sucessfully Register Please Login!')</script>";
      echo  "<script>window.open('checkout.php','_self')</script>";
    }
  }
}else{
  echo "<script>alert('First name/ Email/ Birthday/ Address/ Password must be required!')</script>";
  echo  "<script>window.open('register.php','_self')</script>";
}
}
...
if(isset($_POST['register_connect_menu'])){
  $email_register = htmlentities($_POST['email_register']);
  $password_register = htmlentities($_POST['password_register']);
  $password_register_hash=md5($password_register); //when password is converted in to md5 then must change the code of line 20 or converted $password into $password_hash
  if(!empty($email_register)&&!empty($password_register_hash)){
  $result=mysql_query("select * from account where email='$email_register'");
  if(!$result)
  echo "Error in query.. <br />";
  else {
    while($row=mysql_fetch_array($result,MYSQLI_ASSOC))
    ...
    //echo $uid_database;
    if(($email_register==$email_database)&&($password_register_hash==$password_database_hash)){
      //require 'profile.php';
      header("Location:payment.php?q=".$email_database);
    } else {
...
if(isset($_POST['register_signup_connect'])){
  ...
  if(!empty($first_name)&&!empty($mobile_no)&&!empty($email)&&!empty($password)&&!empty($password_again)){
    if($password_hash!=$password_again_hash){
      ...
      if($query_run=mysql_query($query)){
        ...
        echo  "<script>window.open('checkout.php?q=$email','_self')</script>";
...
<body onload="document.registration.first_name.focus();" >
            ...
            <div id="inner_login_header1">
              ...
              <div id="inner_login_form">
                <form action="" method="post">
                  ...
                  <font id="submit_right"><input type="submit" name="register_signup_connect" value="Sign Up" /></font>
                </div>
              </div>
            </div>
          </li>
          ...
          <li><a href="#"><span> Login</span></a>
            <div id="login_header">
              <div id="inner_login_header">
                ...
                <div id="inner_login_form">
                  <form action="" method="post">
                    <font id="inner_name">Email : </font><font id="inner_email"><input type="email" name="email_register" placeholder="Enter your email." /></font><img src="images/1.png"><br /><br />
                    <font id="inner_pass_name">Password : </font><font id="inner_password"><input type="password" name="password_register" placeholder="Enter your password." /></font><img src="images/2.png"><br />
                    <font id="forget_pass"><a href="">forget Password?</a></font><br />
                    <font id="submit_right"><input type="submit" name="register_connect_menu" value="Sign In" /></font>
                  </div>
                </div>
              </div>
            </li>
  ...
  <div id="section">
    <div class="image_link">
      ...
      <div class="right_menu_register_page">
        <div id="product_menu1">
          <?php cart(); ?>
          <span><font id="z">Welcome</font><a href="customer/account.php?q=<?php echo $uemail_database?>"><?php echo "<font id='user_name'>".@$name_database."</font>" ?></a> <a href="cart.php"><font id="a">Shopping cart</font></a><font id="b">Total item : <?php total_items(); ?></font><font id="b">Total price :<?php total_price(); ?></font> <a href="cart.php"><font id="input"><input type="button" value="Go to Cart" ></a></font></span>
          <script type="text/javascript" src="js/script.js"></script>
          <script type="text/javascript" src="js/jquery.min.js"></script>
        </div>
        ...
        <div class="product_insert_box">
          ...
          <form name='registration' action="" method="post" enctype="multipart/form-data" onSubmit="return formValidation();" >
            <table id="login_table" width="670" >

              <tr >
                <td align="right"><font id="login_register">Login or Register to Buy!</font></td>
              </tr>
              <tr>
                <td align="right"><font id="name_1">First Name :</font></td>
                <td align="left"><font id="input_email"><input type="text" name="first_name" placeholder="First name.."  /></font></td>
              </tr>
              <tr>
                <td align="right"><font id="name_1">Last Name :</font></td>
                <td align="left"><font id="input_email"><input type="text" name="last_name" placeholder="Last name.."   /></font></td>
              </tr>
              <tr>
                <td align="right"><font id="name_1">Mobile no :</font></td>
                <td align="left"><font id="input_email"><input type="text" name="mobile_no" placeholder="+91.."   /></font></td>
              </tr>
              <tr>
                <td align="right"><font id="name_1">Email :</font></td>
                <td align="left"><font id="input_email"><input type="email" name="email" placeholder="Enter Your Email.."   /></font></td>
              </tr>
              <tr>
                <td align="right"><font id="name_1">Profile image :</font></td>
                <td align="left"><font id="input_email"><input type="file" name="profile_image" /></font></td>
              </tr>
              <tr>
                <td align="right"><font id="name_1">Sex :</font></td>
                <td align="left"><font id="input_select">
              ...
              <tr>
              <td align="right"><font id="name_1">Birthday :</font></td>
              <td align="left"><font id="input_email"><input type="date" name="birthday" placeholder="Enter Your Email.."   /></font></td>
            </tr>
            <tr>
              <td align="right"><font id="name_1">Address :</font></td>
              <td align="left"><font id="input_email"><textarea id="text_area" name="address" cols="34" rows="7" placeholder="Enter Your Address.." ></textarea></font></td>
            </tr>
              <tr >
                <td align="right"><font id="name_1">Password :</font></td>
                <td align="left"><font id="input_password"><input type="password" name="password" placeholder="Enter Your Password.." /></font></td>
              </tr>
              <tr >
                <td align="right"><font id="name_1">Password again :</font></td>
                <td align="left"><font id="input_password"><input type="password" name="password_again" placeholder="Enter Password again.." /></font></td>
              </tr>
              <tr>
                <td align="right"><a href="register.php" ><font id="forget_password">Forget Password ?</font></a></td>
              </tr>
              <tr>
                <td align="right"><font id="input_submit"><input type="submit" name="register_connect" value="register"  /></font></td>
              </tr>
          ...
          <a href="checkout.php" >
            ...
            <tr >
              <td><font id="new_register">New? Login Here</font></td>
            </tr>
          </table>
        </a>
        </div>
