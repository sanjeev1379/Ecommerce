...
if(isset($_POST['menu_connect'])){
  $email_menu = htmlentities($_POST['email_menu']);
  $password_menu = htmlentities($_POST['password_menu']);
  $password_menu_hash=md5($password_menu); //when password is converted in to md5 then must change the code of line 20 or converted $password into $password_hash
  if(!empty($email_menu)&&!empty($password_menu_hash)){
    $result_menu=mysql_query("select * from account where email='$email_menu'");
    if(!$result_menu)
    echo "Error in query.. <br />";
    else {
      while($row_1=mysql_fetch_array($result_menu,MYSQLI_ASSOC))
      {
        $email_menu_database=$row_1['email'];
        $password_menu_database_hash=$row_1['password'];
        $uid_menu_database=$row_1['first_name'];
      }
      //echo $uid_database;
      if(($email_menu==$email_menu_database)&&($password_menu_hash==$password_menu_database_hash)){
        //require 'profile.php';
        header("Location:payment.php?q=".$email_menu_database);
      } else {
...
if(isset($_POST['checkout_connect'])){
...
if(isset($_POST['checkout_signup_connect'])){
...
<body>
            ...
            <div id="inner_login_header1">
              ...
              <div id="inner_login_form">
                <form action="" method="post">
                  ...
                  <font id="submit_right"><input type="submit" name="checkout_signup_connect" value="Sign Up" /></font>
                </div>
              </div>
            </div>
          </li>
          ...
          <li><a href="#"><span> Login</span></a>
            <div id="login_header">
              <div id="inner_login_header">
                ...
                <div id="inner_login_form">
                  <form action="" method="post">
                    <font id="inner_name">Email : </font><font id="inner_email"><input type="email" name="email_menu" placeholder="Enter your email." /></font><img src="images/1.png"><br /><br />
                    <font id="inner_pass_name">Password : </font><font id="inner_password"><input type="password" name="password_menu" placeholder="Enter your password." /></font><img src="images/2.png"><br />
                    <font id="forget_pass"><a href="">forget Password?</a></font><br />
                    <font id="submit_right"><input type="submit" name="menu_connect" value="Sign In" /></font>
                  </div>
                </div>
              </div>
            </li>
  ...
  <div id="section">
    <div class="image_link">
      ...
      <div class="right_menu_checkout_page">
        ...
        <div class="product_insert_box">
          ...
          <form  name="myForm"  action="" method="post" enctype="multipart/form-data" >
            <table id="login_table" width="670" >
              ...
              <tr>
                <td align="right"><font id="email">Email :</font></td>
                <td align="left"><font id="input_email"><input type="email" name="email" placeholder="Enter Your Email.."  /></font><font id="image"><img src="images/1.png" /></font></td>
              </tr>
              <tr >
                <td align="right"><font id="password">Password :</font></td>
                <td align="left"><font id="input_password"><input type="password" name="password" placeholder="Enter Your Password.." /></font><font id="image"><img src="images/2.png" /></font></td>
              </tr>
              <tr>
                <td align="right"><a href="register.php" ><font id="forget_password">Forget Password ?</font></a></td>
              </tr>
              <tr>
                <td align="right"><font id="input_submit"><input type="submit" name="checkout_connect" value="Login" /></font></td>
              </tr>

            </table>
          </form><br /><br />
          <a href="register.php" >
          <table id="login_table1">
            <tr >
              <td><font id="new_register">New? Register Here</font></td>
            </tr>
          </table>
        </a>
