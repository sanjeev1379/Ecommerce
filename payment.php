...
if(isset($_POST['payment_connect'])){
  ...
  if(!empty($email)&&!empty($password_hash)){
    ...
    echo "Error in query.. <br />";
      ...
      if(@($email==$email_database)&&($password_hash==$password_database_hash)){
        ...
        echo  "<script>window.open('payment.php?q=.$uemail_database','_self')</script>";
      }
    }
  }else{
...
if(isset($_POST['payment_signup_connect'])){
  ...
  if(!empty($first_name)&&!empty($mobile_no)&&!empty($email)&&!empty($password)&&!empty($password_again)){
    if($password_hash!=$password_again_hash){
      ...
      if($query_run=mysql_query($query)){
        ...
        echo  "<script>window.open('payment.php?q=$email','_self')</script>";
    ...
    <div class="header1">
            ...
            <div id="inner_login_header1">
              ...
              <div id="inner_login_form">
                <form action="" method="post">
                  ...
                  <font id="submit_right"><input type="submit" name="payment_signup_connect" value="Sign Up" /></font>
                </div>
              </div>
            </div>
          </li>
              ...
              <div id="inner_login_header">
                ...
                <div id="inner_login_form">
                  <form action="" method="post">
                    ...
                    <font id="forget_pass"><a href="">forget Password?</a></font><br />
                    <font id="submit_right"><input type="submit" name="payment_connect" value="Sign In" /></font>
                  </div>
                </div>
              </div>
            </li>
      ...
      <div id="section">
        <div class="image_link">
          ...
          <div class="right_menu_payment_page">
            <div id="product_menu">
              <?php cart(); ?>
            ...
            <div class="product_insert_box">
              <div id="payment_box">
                <table id="payment_table" width="670" >

                  <tr >
                    <td align="center"><font id="login_register">Pay now with PayPal :</font></td>
                  </tr>
                  <tr>
                    <td align="center"><a href="" ><img src="images/(R)paypalr.png"  /></a></td>
                  </tr>
                </table>
              </div>
            </div>
