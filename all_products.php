  ...
  if(!empty($email)&&!empty($password_hash)){
    ...
    echo "Error in query.. <br />";
      ...
      if(@($email==$email_database)&&($password_hash==$password_database_hash)){
        //require 'profile.php';
        header("Location:all_products.php?q=".$email_database);
      } else {
...
if(isset($_POST['all_products_signup_connect'])){
  ...
  if(!empty($first_name)&&!empty($mobile_no)&&!empty($email)&&!empty($password)&&!empty($password_again)){
    if($password_hash!=$password_again_hash){
      ...
      if($query_run=mysql_query($query)){
        ...
        echo  "<script>window.open('all_products.php?q=$email','_self')</script>";
...
<body>
            ...
            <div id="inner_login_header1">
              ...
              <div id="inner_login_form">
                <form action="" method="post">
                  ...
                  <font id="submit_right"><input type="submit" name="all_products_signup_connect" value="Sign Up" /></font>
                </div>
              </div>
            </div>
          </li>
              ...
              <div id="inner_login_header">
                ...
                <div id="inner_login_form">
                  <form action="" method="post">
                    ...
                    <font id="forget_pass"><a href="">forget Password?</a></font><br />
                    <font id="submit_right"><input type="submit" name="register_connect" value="Sign In" /></font>
                  </div>
                </div>
              </div>
            </li>
  ...
  <div id="section">
    <div class="image_link">
      ...
      <div class="right_menu_all_products_page">
        <?php cart(); ?>
