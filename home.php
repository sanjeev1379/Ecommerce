...
if(isset($_POST['index_signup_connect'])){
      ...
      <div id="inner_login_header1">
        ...
        <div id="inner_login_form">
          <form action="" method="post">
            ...
            <font id="submit_right"><input type="submit" name="index_signup_connect" value="Sign Up" /></font>
          </div>
        </div>
      </div>
    </li>
        ...
        <div id="inner_login_header">
          ...
          <div id="inner_login_form">
            <form action="" method="post">
              ...
              <font id="forget_pass"><a href="">forget Password?</a></font><br />
              <font id="submit_right"><input type="submit" name="index_connect" value="Sign In" /></font>
            </div>
          </div>
        </div>
      </li>
...
<ol class="abc">
  ...
  <div class="right_menu_home_page">
    <div id="product_menu">
       <?php cart(); ?>
