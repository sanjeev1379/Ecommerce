...
echo "Error in query.. <br />";
  ...
  while($row=mysql_fetch_array($result,MYSQLI_ASSOC))
  {
    ...
    @$birthday_database=$row['birthday'];
    @$address_database=$row['address'];
    @$profile_image_database=$row['profile_image'];
  }
  ...
  if(!empty($email_register)&&!empty($password_register_hash)){
    ...
    echo "Error in query.. <br />";
      ...
      if(($email_register==$email_database)&&($password_register_hash==$password_database_hash)){
        //require 'profile.php';
        header("Location:account.php?q=".$email_database);
      } else {
  ...
  if(!empty($first_name)&&!empty($mobile_no)&&!empty($email)&&!empty($password)&&!empty($password_again)){
    if($password_hash!=$password_again_hash){
      ...
      if($query_run=mysql_query($query)){
        ...
        echo  "<script>window.open('account.php?q=$email','_self')</script>";
...
<body>
  <div class="header">
    <div class="header1">
      ...
      <div id="section">
        <div class="image_link">
          ...
          <div class="right_menu_account_page">
            <div id="product_menu">
              <?php cart(); ?>
              <span><font id="z">Welcome<a href="account.php?q=<?php echo @$uemail_database ?>"></font><?php echo "<font id='user_name'>".@$first_name_database."</font>" ?></a> <a href="../cart.php"><font id="a">Shopping cart</font></a><font id="b">Total item : <?php total_items(); ?></font><font id="b">Total price :<?php total_price(); ?></font> <a href="../cart.php"><input type="button" value="Go to Cart" ></a></span>
              <script type="text/javascript" src="../js/script.js"></script>
              <script type="text/javascript" src="../js/jquery.min.js"></script>
            </div>
            ...
            <div class="product_insert_box">
              <div id="account_box">
                <table id="account_table" width="670" >
                  <tr >
                    <td align="right"><font id="account_update">View and Update Profile!</font></td>
                    <td align="right"><font id="account_image"><?php echo "<img src='customer_images/$profile_image_database' width='100' height='100' />" ?></font></td>
                  </tr>
                  <tr>
                    <td align="right"><font id="account">Username :</font></td>
                    <td align="left"><font id="account1"><?php echo $first_name_database." " .$last_name_database?></font></td>
                  </tr>
                  <tr >
                    <td align="right"><font id="account">Email :</font></td>
                    <td align="left"><font id="account1"><?php echo $uemail_database?></font></td>
                  </tr>
                  <tr >
                    <td align="right"><font id="account">Mobile no :</font></td>
                    <td align="left"><font id="account1"><?php echo $mobile_no_database?></font></td>
                  </tr>
                  <tr >
                    <td align="right"><font id="account">Date of Birth :</font></td>
                    <td align="left"><font id="account1"><?php echo $birthday_database?></font></td>
                  </tr>
                  <tr >
                    <td align="right"><font id="account">permanent Address :</font></td>
                    <td align="left"><font id="account1"><?php echo $address_database?></font></td>
                  </tr>
                  <tr >
                    <td align="right"><font id="account">Crosspondent Address :</font></td>
                    <td align="left"><font id="account1"><?php echo $address_database?></font></td>
                  </tr>
                  <tr>
                    <td align="left"><a href="../payment.php?q=<?php echo $uemail_database ?>"><font id="account_go_back">Go Back</font></a></td>
                    <td align="right"><font id="input_submit_logout"><form action="" method="post" ><input type="submit" name="logout_user" value="Logout" /></form></font></td>
                  </tr>
                </table>
              </div>
            </div>
    ...
    if(isset($_POST['logout_user'])){
      ...
      echo "<script>alert('You logout in successfully , Thanks!')</script>";
